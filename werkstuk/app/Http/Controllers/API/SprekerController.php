...
class SprekerController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->sendResponse(SprekerResource::collection($speakers), 'Speakers retrieved successfully.');
    }
    // /**
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new SprekerResource($speaker), 'Speaker retrieved successfully.');
    }
