...
class PartnerTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $partner = new Partner([
            ...
            'imgname' => 'bozar.jpg',
            'img' => base64_encode(file_get_contents(storage_path('app/public/logos/bozar.png')))
        ]);
        $partner->save();
        $partner = new Partner([
            ...
            'imgname' => 'ehb.jpg',
            'img' => base64_encode(file_get_contents(storage_path('app/public/logos/ehb.png')))
        ]);
        $partner->save();
        $partner = new Partner([
            'name' => 'Brussel Stad',
            ...
            'imgname' => 'bxl.jpg',
            'img' => base64_encode(file_get_contents(storage_path('app/public/logos/brussels.png')))
        ]);
        $partner->save();
        $partner = new Partner([
            'name' => 'Imec',
        ...
        $partner = new Partner([
            ...
            'imgname' => 'voka.jpeg',
            'img' => base64_encode(file_get_contents(storage_path('app/public/logos/voka.png')))
        ]);
        $partner->save();
        $partner = new Partner([
            'name' => 'MeetDistrict',
        ...
        $partner = new Partner([
            ...
            'img' => base64_encode(file_get_contents(storage_path('app/public/logos/ewi.png')))
        ]);
        $partner->save();
        $partner = new Partner([
            'name' => 'Cegeka',
